            ...
            <form onSubmit={adPost} encType="multipart/form-data">
                <div className="post-back">
                  ...
                  title"
                                    ...
                                    <input type="text" placeholder="Address" name="Enter Your title" required
                                        id="standard-basic"
                                        value={Obj.title}
                                        label="
                  title"
                                    ...
                                    <div className="field-second">
                                        <div style={{ marginTop: '23px' }}>
                                            ...
                                            <FormControl sx={{ m: 1, width: 300 }} className="formcontrol">
                                                <InputLabel id="demo-multiple-name-label" className="labelc">Property Type</InputLabel>
                                        ...
                                        <div style={{ marginTop: '23px' }}>
                                            ...
                                            <FormControl sx={{ m: 1, width: 300 }} className="formcontrol">
                                                <InputLabel id="demo-multiple-name-label" className="labelc">Condition</InputLabel>
                                                <Select style={{ borderRadius: '20px' }}
                                                    labelId="demo-multiple-name-label"
                                                    id="demo-multiple-name"
                                                    multiple
